...
FUNCTION_GROUPS = [
    ...
    "43 - Brakes - pneumatic system and auxiliary brakes",
    "46 - Steering",
    "47 - Fuel system, powertrain energy supply",
    "49 - Exhaust system, exhaust gas cleaning",
    "54 - Electrical system, equipment and instruments",
    "55 - Auxiliary drive systems, hydraulic and linkage systems",
    "57 - Central lubrication system",
    "58 - Tools",
    "60 - Body - general",
    "61 - Substructure",
    ...
    "72 - Doors",
    "77 - Sliding roof, soft top, top attachments",
    "80 - Central locking system, convenience operation, drive authorization systems",
    "82 - Electrical system, body",
    "83 - Climate control",
    "86 - Emergency equipment, diability equipment, sanitary equipment, galley",
    "88 - Detachable body components, exterior flaps",
    "91 - Seats, bunks, restraint systems",
    "94 - Body noises, noise insulation",
